...
export class PDFGenerator {
    public async generatePDF(data: PDF): Promise<Buffer> {
        return new Promise<Buffer>((resolve) => {
            ...
            doc.font('Helvetica-Bold').fontSize(20).text('RESULT STATEMENT', { align: 'center' }).moveDown(1);
            ...
            doc.fontSize(16).fillColor('green').text(data.profit, { align: 'center' }).moveDown(1);
            ...
            doc.fontSize(10).text(`Contracted Performance Fee: ${data.preformanceFee}%`).moveDown(2);
            ...
            const tableTwo = {
                ...
                headers: [
                    ...
                    { label: "Variation", property: 'variation', width: 140, renderer: null },
            ...
            doc.fontSize(10).fillColor('green').text(`US$ ${data.profit}`, {
                align: 'right',
            }).moveDown(0.3);
